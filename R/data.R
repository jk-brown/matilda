...
#'
#' @description
#' This is historic CO2 concentration data from the Indicators of Climate Change paper (2023).
#' It was accessed online via \url{https://zenodo.org/records/8000192} where original code repositories
#' are linked. We cited the source of the original code repository for this dataset below. This data is used
#' to create the criterion_historic_co2 weighting criterion.
#'
#' @details
#' Data were accessed on 05/09/2024 from source:
#' \url{https://github.com/ClimateIndicator/forcing-timeseries/tree/main/data/ghg_concentrations/ar6_updated}
#'
...
#' Earth Syst. Sci. Data, 15, 2295–2327, \url{https://doi.org/10.5194/essd-15-2295-2023}, 2023.
#'
#' @format
#'  A data frame with 180 observations of 2 variables
#'
#' \describe{
#' \item{\code{year}}{Integer. Year the data were recorded from 1750-2023.}
